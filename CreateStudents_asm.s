...
CreateStudent:
    ...
    addiu $sp, $sp, -32          # Cria espaço na pilha
    ...
    addiu $a1, $s0, 4           # Offset para o campo 'name' na estrutura
    ...
    addiu $sp, $sp, 32          # Ajusta a pilha de volta
